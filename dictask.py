...
print(complex_dict["config"]["features"]["experiments"][2][0])

list1 = list(complex_dict["projects"][0]["tags"])
list1.sort()
print(list1[-1])

print(complex_dict["misc"][0]["nested_tuple_dict"])
print(complex_dict.keys())

new_dict = complex_dict["user"].copy()
print(new_dict)